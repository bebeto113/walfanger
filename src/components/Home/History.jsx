    ...
    return (
        <section className="relative w-full bg-[#fcfaf7] py-24 md:py-40 overflow-hidden font-sans">
            ...
            <div className="container mx-auto px-6 relative max-w-5xl">
                ...
                {/* A LINHA CENTRAL (Desenha ao rolar no Desktop) */}
                ...
                <div className="flex flex-col gap-24 md:gap-32">
                    {timelineData.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute left-0 md:left-1/2 -translate-x-1/2 w-3 h-3 bg-[#fcfaf7] border-2 border-[#c4a673] rounded-full z-10 hidden md:block" />

                            {/* LADO 1: O ANO */}
                            <div className={`w-full md:w-1/2 pl-12 md:pl-0 md:px-16 ${index % 2 === 0 ? 'text-left md:text-left' : 'text-left md:text-right'
                                }`}>
                                <span className="text-5xl md:text-8xl font-serif font-black text-[#2a2622]/[0.08] block md:inline-block leading-none">
                                    {item.year}
                                </span>
                            </div>
                            ...
                            <div className={`w-full md:w-1/2 pl-12 md:pl-0 md:px-16 mt-4 md:mt-0`}>
                                <div className="max-w-md">
                                    <h4 className="text-[#c4a673] text-[11px] uppercase tracking-[0.3em] font-black mb-3">
                                        {item.title}
                                    </h4>
            ...
            {/* SELO DE QUALIDADE AO FINAL */}
            <motion.div
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                className="mt-32 md:mt-48 flex flex-col items-center justify-center"
            >
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border border-[#e3d8c1] flex items-center justify-center p-4 text-center">
                    <span className="text-[#c4a673] text-[9px] md:text-[10px] font-bold uppercase tracking-widest leading-tight">
