...
const Hero = () => {
    return (
        <>
            <section className="relative min-h-screen w-full bg-[#fcfaf7] overflow-hidden flex flex-col items-center justify-center md:pt-5 pt-20 pb-10">
                ...
                {/* DETALHES LATERAIS */}
                <div className="absolute left-8 md:left-16 top-1/2 -translate-y-1/2 md:-mt-[30vh] hidden lg:flex flex-col items-center gap-6 z-10">
                ...
                <div className="container mx-auto px-6 relative z-20 flex flex-col items-center text-center">
                    ...
                    <motion.div
                        ...
                        className="-mb-4"
                    >
                        <span className="text-[#8c8273] uppercase tracking-[0.4em] md:text-xs text-[10px]  font-semibold flex items-center gap-4">
                    ...
                    <div className="relative w-full flex justify-center items-center mt-4 md:mt-8">
                        ...
                        >
                            <span className='z-10'> A VERDADEIRA </span><br />
                            <motion.span
                                initial={{ scale: 0.95 }}
                                animate={{ scale: 1 }}
                                transition={{ duration: 0.8, delay: 0.2 }}
                                className="text-[#e3d8c1] relative z-30 -left-4  italic font-medium ml-8 md:ml-32">
                                <span className=" text-[#e3d8c1]">
                                    ALMA
                                    <span className='text-[#FFCE00] '> A</span>
                                    <span className='text-[#DD0000] '>L</span>
                                    <span className='text-[#000000] '>E</span>
                                    <span className='text-[#FFCE00] '>M</span>
                                    <span className='text-[#DD0000] '>Ã</span>
                                </span>
                            </motion.span>
                        </motion.h1>
                        ...
                        <motion.div
                            initial={{ opacity: 0, y: 60, zIndex: 0 }}
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute top-[15%] md:top-[10%] -left-20 sm:-left-20 md:-left-24 bg-white/70 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 border border-[#e3d8c1] rounded-sm shadow-sm z-20 scale-[0.65] sm:scale-90 md:scale-100 origin-right seal-blur"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-[17%] -right-[78px] md:bottom-[7%] sm:-right-20 md:-right-[100px] bg-white/70 backdrop-blur-sm px-3 py-1.5 md:px-4 md:py-2 border border-[#e3d8c1] rounded-sm shadow-sm z-20 scale-[0.65] sm:scale-90 md:scale-100 origin-left seal-blur"
                            >
                            ...
                            <img
                                src={DOPPELBOCK}
                                alt="Walfänger Beer"
                                className="relative h-[42vh] md:h-[60vh] drop-shadow-2xl z-30"
                            />
                        </motion.div>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-6 w-full sm:w-auto px-4">
                            ...
                            {/* BOTÃO 1: PRINCIPAL */}
                            <Link to="/cervejas" className="group relative flex items-center justify-center gap-4 w-full sm:w-auto bg-[#2a2622] text-white px-8 py-4 text-[10px] md:text-xs font-bold uppercase tracking-[0.25em] overflow-hidden transition-all duration-500 hover:shadow-[0_10px_40px_-10px_rgba(42,38,34,0.4)]">
